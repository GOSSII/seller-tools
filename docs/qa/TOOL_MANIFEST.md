...
| 6 | `advertising-roi` | Advertising **ROAS** Calculator | `/#/advertising-roi` | What a PPC budget projects | PPC budget, avg CPC, conversion rate, AOV | Est. clicks, est. orders, projected ad-attributed sales, ACOS, ROAS — all "—" when CPC or CVR is 0 |
