...
| [BUG_REGISTER.md](BUG_REGISTER.md) | 28 defects + 1 privacy finding, with expected vs actual, root cause, fix, regression test and status |
...
Still to review: the landing page *(in review)* → the shared-layout calculators in batches.
